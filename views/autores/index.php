...
/* Botones de acción */
.grid-wrap .btn-default,
.grid-wrap a[data-pjax="0"] {
    font-size: 0.8rem;
    padding: 4px 10px;
    border-radius: 6px;
    border: 1px solid #ddd8ce;
...
.grid-wrap a[href*="view"] { color: #185fa5; border-color: #b5d4f4; }
.grid-wrap a[href*="view"]:hover { background: #e6f1fb; }
.grid-wrap a[href*="update"] { color: #3b6d11; border-color: #c0dd97; }
.grid-wrap a[href*="update"]:hover { background: #eaf3de; }
.grid-wrap a[href*="delete"] { color: #a32d2d; border-color: #f7c1c1; }
...
<div class="autores-index">
    ...
    <div class="module-header">
        <div class="module-header-left">
            <div class="page-badge"><i class="ti ti-user-edit"></i> Gestión</div>
            <h1>Autores</h1>
        </div>
        <?= Html::a(
    ...
    <div class="grid-wrap">
        ...
        <?= GridView::widget([
            ...
            'summary'      => '<div class="summary">Mostrando {begin}–{end} de {totalCount} autores</div>',
            'columns' => [
